...
public class Couracado extends Arma {
	public Couracado(int x, int y, int relX, int relY) {
		super(x, y, relX, relY);
	...
	public static int getLarguraPadrao() {
		return QuadradoArma.getLargura() * 5;
	}
	...
	public void rotate(int relX, int relY) {
		...
		switch(this.rot) {
			case ZeroGraus:
				this.largura = QuadradoArma.getLargura() * 5;
				...
				loqa.add(new QuadradoArma(QuadradoArma.getLargura() * 4, 0, this.relX + 4, this.relY));
				break;
			case NoventaGraus:
				this.largura = QuadradoArma.getLargura();
				this.altura = QuadradoArma.getAltura() * 5;
				loqa.add(new QuadradoArma(0,0, this.relX, this.relY));
				...
				loqa.add(new QuadradoArma(0, QuadradoArma.getAltura() * 4, this.relX, this.relY + 4));
				break;
